...
{
public interface AllorsInterfaceDateTimeCell : Iseries.Cell,  AllorsObject
	{
	}
	
 
	public abstract class AllorsClassDateTimeCell :  AllorsObject
	{
		...
		virtual public System.DateTime Value 
		{
			get
			{
				return (System.DateTime) allors.GetUnitRole(AllorsDomains.IseriesDomain.DateTimeCellValue);
			}
			set
			{
				allors.SetUnitRole(AllorsDomains.IseriesDomain.DateTimeCellValue,value);
			}
		}
		virtual public bool ExistValue{
			get
			{
				return allors.ExistUnitRole(AllorsDomains.IseriesDomain.DateTimeCellValue);
			}
		}
		virtual public void RemoveValue()
		{
			allors.RemoveUnitRole(AllorsDomains.IseriesDomain.DateTimeCellValue);
		}
