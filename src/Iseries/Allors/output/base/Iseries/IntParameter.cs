...
{
public interface AllorsInterfaceIntParameter : Iseries.Parameter,  AllorsObject
	{
	}
	
 
	public abstract class AllorsClassIntParameter :  AllorsObject
	{
		...
		virtual public System.Int32 Value 
		{
			get
			{
				return (System.Int32) allors.GetUnitRole(AllorsDomains.IseriesDomain.IntParameterValue);
			}
			set
			{
				allors.SetUnitRole(AllorsDomains.IseriesDomain.IntParameterValue,value);
			}
		}
		virtual public bool ExistValue{
			get
			{
				return allors.ExistUnitRole(AllorsDomains.IseriesDomain.IntParameterValue);
			}
		}
		virtual public void RemoveValue()
		{
			allors.RemoveUnitRole(AllorsDomains.IseriesDomain.IntParameterValue);
		}
