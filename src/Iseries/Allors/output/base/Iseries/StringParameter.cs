...
{
public interface AllorsInterfaceStringParameter : Iseries.Parameter,  AllorsObject
	{
	}
	
 
	public abstract class AllorsClassStringParameter :  AllorsObject
	{
		...
		protected AllorsClassStringParameter(AllorsStrategy allors){this.allors=allors;}
		...
		virtual public System.Int32 Length 
		{
			get
			{
				return (System.Int32) allors.GetUnitRole(AllorsDomains.IseriesDomain.StringParameterLength);
			}
			set
			{
				allors.SetUnitRole(AllorsDomains.IseriesDomain.StringParameterLength,value);
			}
		}
		virtual public bool ExistLength{
			get
			{
				return allors.ExistUnitRole(AllorsDomains.IseriesDomain.StringParameterLength);
			}
		}
		virtual public void RemoveLength()
		{
			allors.RemoveUnitRole(AllorsDomains.IseriesDomain.StringParameterLength);
		}
		...
		virtual public System.String Value 
		{
			get
			{
				return (System.String) allors.GetUnitRole(AllorsDomains.IseriesDomain.StringParameterValue);
			}
			set
			{
				allors.SetUnitRole(AllorsDomains.IseriesDomain.StringParameterValue,value);
			}
		}
		virtual public bool ExistValue{
			get
			{
				return allors.ExistUnitRole(AllorsDomains.IseriesDomain.StringParameterValue);
			}
		}
		virtual public void RemoveValue()
		{
			allors.RemoveUnitRole(AllorsDomains.IseriesDomain.StringParameterValue);
		}
