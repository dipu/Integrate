...
{
public interface AllorsInterfaceDateTimeParameter : Iseries.Parameter,  AllorsObject
	{
	}
	
 
	public abstract class AllorsClassDateTimeParameter :  AllorsObject
	{
		...
		virtual public System.DateTime Value 
		{
			get
			{
				return (System.DateTime) allors.GetUnitRole(AllorsDomains.IseriesDomain.DateTimeParameterValue);
			}
			set
			{
				allors.SetUnitRole(AllorsDomains.IseriesDomain.DateTimeParameterValue,value);
			}
		}
		virtual public bool ExistValue{
			get
			{
				return allors.ExistUnitRole(AllorsDomains.IseriesDomain.DateTimeParameterValue);
			}
		}
		virtual public void RemoveValue()
		{
			allors.RemoveUnitRole(AllorsDomains.IseriesDomain.DateTimeParameterValue);
		}
